        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          ...
          <div className="mb-8">
            <div className="bg-white dark:bg-night-800 rounded-2xl shadow-lg p-12">
              <div className="text-center">
                <h2 className="text-2xl font-bold text-primary-600 dark:text-primary-400 mb-4 font-serif">Make a Donation Today</h2>
          ...
          <div className="bg-white dark:bg-night-800 rounded-2xl shadow-lg p-8">
            <h2 className="text-2xl font-bold text-primary-600 dark:text-primary-400 text-center mb-6 font-serif">About the CJD Foundation</h2>
            ...
            <div className="space-y-4 text-base leading-7 text-gray-600 dark:text-gray-400 font-serif">
              ...
              <div className="mt-8">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">What They Do</h3>

                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-gray-100">Direct Family Support:</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-gray-100">Research & Education:</h4>
                    <ul className="list-disc list-inside space-y-1 mt-2">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 dark:text-gray-100">Advocacy:</h4>
                    <ul className="list-disc list-inside space-y-1 mt-2">
